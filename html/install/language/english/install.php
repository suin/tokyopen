...
define("_INSTALL_L0","Welcome to the Install Wizard for TOKYOPen");
define("_INSTALL_L70","Please change the file permission for settings/definition.custom.php so that it is writeable by the server (i.e. chmod 777 settings/definition.custom.php on a UNIX/LINUX server, or check the properties of the file and make sure the read-only flag is not set on a Windows server ). Reload this page once you have changed the permission setting.");
//define("_INSTALL_L71","Click on the button below to begin the installation.");
define("_INSTALL_L1","Open settings/definition.custom.php with your text editor and find the following codes on line 31:");
...
define("_INSTALL_L6","There is a mismatch between your XOOPS_ROOT_PATH configuration on line 31 of settings/definition.custom.php and the root path info we have detected.");
...
define("_INSTALL_L11","The server path to your TOKYOPen root directory: ");
define("_INSTALL_L12","URL to your TOKYOPen root directory: ");
define("_INSTALL_L13","If the above setting is correct, press the button below to continue.");
define("_INSTALL_L14","Next");
define("_INSTALL_L15","Please open settings/definition.custom.php and enter required DB settings data");
...
define("_INSTALL_L19","%s is the name of your database in which TOKYOPen tables will be created.");
...
define("_INSTALL_L25","We have detected the following database information from your configuration in settings/definition.custom.php. Please fix it now if this is not correct.");
...
define("_INSTALL_L55","TOKYOPen Physical Path");
define("_INSTALL_L59","Physical path to your main TOKYOPen directory WITHOUT trailing slash");
define("_INSTALL_L56","TOKYOPen Virtual Path (URL)");
define("_INSTALL_L58","Virtual path to your main TOKYOPen directory WITHOUT trailing slash");
...
define("_INSTALL_L35","If you had any errors, please contact the dev team at <a href='http://xoopscube.sourceforge.net/' target='_blank'>TOKYOPen Project</a>");
...
define("_INSTALL_L60","Could not write into settings/definition.custom.php. Please check the file permission and try again.");
define("_INSTALL_L61","Could not write to settings/definition.custom.php. Contact the server administrator for details.");
define("_INSTALL_L62","Configuration data has been saved successfully to settings/definition.custom.php.");
...
define("_INSTALL_L131","Tables for TOKYOPen already exist in your database.");
...
define("_INSTALL_L141","The installer will now update each module to work with TOKYOPen.<br />Make sure that you have uploaded all files in TOKYOPen package to your server.<br />This may take a while to complete.");
define("_INSTALL_L142","Updating modules..");
define("_INSTALL_L143","The installer will now update configuration data of XOOPS 1.3.x to be used with TOKYOPen.");
...
define("_INSTALL_L149","The installer will now update comment posts in XOOPS 1.3.x to be used in TOKYOPen.<br />This may take a while to complete.");
define("_INSTALL_L150","The installer will now update the smiley and user rank images to be used with TOKYOPen.<br />This may take a while to complete.");
define("_INSTALL_L151","The installer will now update the user avatar images to be used in TOKYOPen.<br />This may take a while to complete.");
...
define('_INSTALL_FILE_NOT_FOUND', "File %s NOT FOUND.");
define('_INSTALL_DIRECTORY_NOT_FOUND', "Directory %s NOT FOUND.");
