...
define("_INSTALL_L0","TOKYOPen インストールウィザードへようこそ");
define("_INSTALL_L70","サーバ上のsettings/definition.custom.php への書き込み権限を与えてください。<br />（例：UNIX/LINUXサーバの場合はchmod 777 settings/definition.custom.php、Windowsサーバの場合は読み取り専用プロパティがセットされていないかチェックする。）<br />権限の設定完了後、ブラウザの「更新」ボタンを押してこのページを再度読み込んでください。");
//define("_INSTALL_L71","下記のボタンをクリックするとインストールを開始します。");
define("_INSTALL_L1","settings/definition.custom.phpを開き、31行目に以下のコードがあることを確認してください。");
...
define("_INSTALL_L6","settings/definition.custom.phpに設定してあるXOOPS_ROOT_PATHと、インストールウィザードが検知したパス設定が異なっています。");
define("_INSTALL_L7","settings/definition.custom.phpの設定：");
...
define("_INSTALL_L11","TOKYOPenのディレクトリへのパス：");
define("_INSTALL_L12","TOKYOPenへのURL：");
define("_INSTALL_L13","上記設定が正しい場合は、インストールを続けてください。<br />間違っている場合は、はじめからやり直してください。<br />または、settings/definition.custom.phpを直接編集して、このページを再読み込みしてください。");
define("_INSTALL_L14","次へ");
define("_INSTALL_L15","settings/definition.custom.phpを開き、必要な設定をすべて記入してください");
...
define("_INSTALL_L19","%s はTOKYOPenが使用するデータベースの名前です。");
define("_INSTALL_L20","%s はTOKYOPenが使用する各データベーステーブルに付加されるprefix（接頭語）です。prefixを付加することで、既存テーブルとのテーブル名称の重複を防ぎます。");
...
define("_INSTALL_L25","settings/definition.custom.phpに記述された以下の設定に間違いがないか確認してください。");
...
define("_INSTALL_L55","TOKYOPenへのパス");
define("_INSTALL_L59","　TOKYOPenが設置されているディレクトリへのフルパスを入力してください。<br />　末尾には「/」を付加しないでください。");
define("_INSTALL_L56","TOKYOPenへのURL");
define("_INSTALL_L58","　TOKYOPenにアクセスするURLを入力してください。<br />　末尾には「/」を付加しないでください。");
...
define("_INSTALL_L35","インストール中にエラーが発生した場合は<a href='http://tokyopen.org/'>TOKYOPen</a>のサポートフォーラムをご利用ください。");
...
define("_INSTALL_L46","TOKYOPenのモジュールが正常に動作するには、下記のファイルがサーバにより書き込み可能になっている必要があります。（UNIX/LINUXサーバをご使用の場合、各ファイルのパーミッションを666または777に設定してください。）");
define("_INSTALL_L47","次へ");

define("_INSTALL_L53","設定内容の確認");

define("_INSTALL_L60","settings/definition.custom.phpの読み込みに失敗しました。ファイルパーミッションの設定を確認してください。");
define("_INSTALL_L61","settings/definition.custom.phpへの書き込みに失敗しました。サーバ管理者まで問い合わせください。");
define("_INSTALL_L62","設定を、settings/definition.custom.phpへ書き込みました。");
...
define("_INSTALL_L131","TOKYOPenのテーブルがデータベースに既に存在します。");
...
define("_INSTALL_L141","インストーラは今から、TOKYOPenで動くように各モジュールをアップデートします。<br />TOKYOPenのパッケージに含まれるすべてのファイルがサーバにアップロードされているか確認してください。<br />これが完了するまでには、しばらく時間が掛かるかもしれません。");
...
define("_INSTALL_L149","インストーラは今から、TOKYOPenで使えるようにXOOPS 1.3.xのコメントポストをアップデートします。<br />これが完了するまでには、しばらく時間が掛かるかもしれません。");
define("_INSTALL_L150","インストーラは今から、TOKYOPenで使えるように顔アイコンとユーザランキングの画像をアップデートします。<br />これが完了するまでには、しばらく時間が掛かるかもしれません。");
define("_INSTALL_L151","インストーラは今から、TOKYOPenで使えるようにユーザアバターの画像をアップデートします。<br />これが完了するまでには、しばらく時間が掛かるかもしれません。");
...
define("_INSTALL_L165","このサイトはただいまメンテナンス中です。後ほどお越しください。");
...
define('_INSTALL_FILE_NOT_FOUND', "ファイル%sが見つかりません。");
define('_INSTALL_DIRECTORY_NOT_FOUND', "ディレクトリ%sが見つかりません。");
