...
var bkLib = {
	...
	onDomLoaded : function(fireThis) {
		...
		if (document.addEventListener) {
			...
			// To emulate DOMContentLoaded in IE refs http://stackoverflow.com/questions/1235985/attach-a-body-onload-event-with-js
...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
		...
		this.elm = elm;
		this.pos = {};
		this.pos[0] = elm.offsetLeft;
		this.pos[1] = elm.offsetTop + elm.clientHeight;
		...
		this.contain.noSelect().appendTo(nicEditor.nicPanel.elm);
