<?php
/**
 * preloadでコントローラを呼び出すためのディスパッチャー
 */

class Pengin_Dispatcher_Preload extends Pengin_Dispatcher_User
{
	...
	protected function _checkControllerName()
	{
		...
		$this->controller = 'preload_'.$this->controller;
	}
	...
	protected function _checkControllerClass()
	{
		...
		{
			throw new RuntimeException("Preload controller {$this->controllerClass} not found");
		}
	}
