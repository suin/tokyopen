...
class User_MailjobEditAction extends User_AbstractEditAction
{
	...
	function executeViewInput(&$controller, &$xoopsUser, &$render)
	{
        ...
        $render->setAttribute('from_name', $this->mActionForm->get('from_name') ? $this->mActionForm->get('from_name') : $xoopsMailerConfig['fromname']);
        $render->setAttribute('from_email', $this->mActionForm->get('from_email') ? $this->mActionForm->get('from_email') : $xoopsMailerConfig['from']);
	}
