...
// @ryusdist
define('_MI_USER_CONF_LOST_PASS_METHOD', "Verification mMethod of lost password");
define('_MI_USER_CONF_LOST_PASS_METHOD_EMAIL', "Verify with email");
define('_MI_USER_CONF_LOST_PASS_METHOD_UNAME', "Verify with user name");
?>
