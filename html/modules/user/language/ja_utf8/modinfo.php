...
// @ryusdist
define('_MI_USER_CONF_LOST_PASS_METHOD', "パスワード再発行方法");
define('_MI_USER_CONF_LOST_PASS_METHOD_EMAIL', "メールアドレスで照合");
define('_MI_USER_CONF_LOST_PASS_METHOD_UNAME', "ユーザ名で照合");
?>
