 ...
 */
var SiteNavi_Sitemap_ContextMenu_Delete = function(app) {
	this.app = app;
};

SiteNavi_Sitemap_ContextMenu_Delete.prototype = {
	 ...
	 */
	outlet: {
		form: '#SiteNavi_Controller_AdminPageDelete',
		formSubmitButton: '#SiteNavi_Controller_AdminPageDelete input[type=submit]'
	},
	 ...
	 * @constant
	 */
	FORM_URL: '/index.php?controller=page_delete&ajaxmode=1',
	...
	_registerEventListeners: function(contextMenu) {
		...
		contextMenu.delegate('delete', function(data){ self._clickMenuEventHandler(data); });
	},
