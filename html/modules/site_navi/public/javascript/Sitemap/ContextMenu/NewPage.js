 ...
 */
var SiteNavi_Sitemap_ContextMenu_NewPage = function(app) {
	this.app = app;
};

SiteNavi_Sitemap_ContextMenu_NewPage.prototype = {
	 ...
	 */
	outlet: {
		form: '#SiteNavi_Form_AdminPageNew',
		formSubmitButton: '#SiteNavi_Form_AdminPageNew input[type=submit]'
	},
	 ...
	 * @constant
	 */
	FORM_URL: '/index.php?controller=page_new&ajaxmode=1',
	...
	_registerEventListeners: function(contextMenu) {
		...
		contextMenu.delegate('newPage', function(data){ self._clickMenuEventHandler(data); });
	},
