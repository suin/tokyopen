...
class ryusRenderIniChecker
 {
    public static function doCheck()
    {
        ...
        if (
            ...
            and
            isset($site_config_ryus['root'])
            and
            isset($site_config_ryus['path'])
            and
            isset($site_config_ryus['class'])
            ) {
            $classfile = sprintf(
                                 '%s%s/%s.class.php',
    ...
    private static function ryusRenderExit()
    {
        ...
        // inquiry XCL taisaku
        $root->mSiteConfig['RenderSystems']['Inquiry_RenderSystem']
            = 'Legacy_RenderSystem';
        $root->mSiteConfig['RenderSystems']['Legacy_RenderSystem']
            = 'Legacy_RenderSystem';
        $root->mSiteConfig['RenderSystems']['Legacy_AdminRenderSystem']
            = 'Legacy_RenderSystem';
