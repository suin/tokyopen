...
class RapidModuleUpdator extends XCube_ActionFilter
{
	...
	{
		if ( $this->_isModuleListPage() === true )
		{
	...
	protected function _isModuleListPage()
	{
		if ( preg_match('#/modules/legacy/admin/index.php$#', $_SERVER['SCRIPT_NAME']) === 0 )
		{
			return false;
		}

		if ( isset($_GET['action']) === true and $_GET['action'] !== 'ModuleList' )
		{
			return false;
		}
