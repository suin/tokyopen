...
class SetupAltsysLangMgr extends XCube_ActionFilter
{
	...
	static function createLanguageManager(&$langManager, $languageName)
	{
...
class AltsysLangMgr_LanguageManager extends Legacy_LanguageManager
{
	...
	{
		if ($this->langman->my_language) {
			$mylang_file = $this->langman->my_language . '/' . $this->mLanguageName . '/' . $fileBodyName . '.php';
