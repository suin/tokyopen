...
$definitionCustom = dirname(__FILE__).'/settings/definition.custom.php';

if ( file_exists($definitionCustom) === false and defined('XOOPS_INSTALL') === false ) {
